...
//defines gerais 
#define ID_MQTT  "IoTFATEAModulo02"     //id mqtt (para identificação de sessão)
#define ENDERECO_MODULO      2         //endereço deste módulo
#define ENDERECO_MODULO_STR  "2"       //endereço deste módulo
#define TOPICO_SUBSCRIBE "IoTFATEAPublisher"     //tópico MQTT de escuta
#define TOPICO_PUBLISH   "IoTFATEASubscriber"    //tópico MQTT de envio de informações para Broker
